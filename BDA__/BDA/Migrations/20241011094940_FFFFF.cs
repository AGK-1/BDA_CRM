        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Companydomain = table.Column<string>(name: "Company_domain", type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserkoId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VerificationTokens_AspNetUsers_UserkoId",
                        column: x => x.UserkoId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Emails_Customers_SentToCustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastEmailSentAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastClientResponseAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangedReason = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LeadStageHistories_Users_ChangedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Emails_SentToCustomerId",
                table: "Emails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeadStageHistories_ChangedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VerificationTokens_UserkoId",
